...
import no.nav.familie.integrasjoner.enhet.SaksbehandlerId
import no.nav.familie.integrasjoner.enhet.TilgangV2DTO
...
class AxsysRestClient(
    ...
    fun hentTilgang(saksbehandlerId: SaksbehandlerId): TilgangV2DTO {
        val uri = UriComponentsBuilder.fromUri(enhetBaseUrl)
