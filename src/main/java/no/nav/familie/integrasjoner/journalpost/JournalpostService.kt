...
class JournalpostService
    ...
    constructor(
        ...
        fun finnTilgangsstyrteJournalposter(journalposterForBrukerRequest: JournalposterForBrukerRequest): List<TilgangsstyrtJournalpost> {
            val journalposter = safRestClient.finnJournalposter(journalposterForBrukerRequest)
            return tilgangsstyrtJournalpostService.tilTilgangstyrteJournalposter(journalposter)
        }
