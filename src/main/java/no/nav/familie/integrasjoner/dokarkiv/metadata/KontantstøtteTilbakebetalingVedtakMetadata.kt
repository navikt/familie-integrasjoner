...
@Component
object KontantstøtteTilbakebetalingVedtakMetadata : Dokumentmetadata {
    ...
    override val dokumenttype: Dokumenttype = Dokumenttype.KONTANTSTØTTE_TILBAKEKREVING_VEDTAK
