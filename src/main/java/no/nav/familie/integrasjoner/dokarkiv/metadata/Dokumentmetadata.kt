...
fun Dokumenttype.tilMetadata(): Dokumentmetadata =
    when (this) {
        ...
        Dokumenttype.BARNETRYGD_INFORMASJONSBREV_INNHENTE_OPPLYSNINGER_KLAGE_INSTITUSJON -> BarnetrygdInformasjonsbrevInnhenteOpplysningerKlageInstitusjonMetadata
