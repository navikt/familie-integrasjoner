...
fun Dokumenttype.tilDokumentmetadata(): Dokumentmetadata {
    return when (this) {
        ...
        Dokumenttype.BARNETRYGD_VARSEL_OM_REVURDERING_INSTITUSJON -> TODO()
        Dokumenttype.KLAGE_VEDTAKSBREV_OVERGANGSSTØNAD -> TODO()
        Dokumenttype.KLAGE_VEDTAKSBREV_BARNETILSYN -> TODO()
        Dokumenttype.KLAGE_VEDTAKSBREV_SKOLEPENGER -> TODO()
        Dokumenttype.KLAGE_VEDTAKSBREV_BARNETRYGD -> TODO()
        Dokumenttype.KLAGE_VEDTAKSBREV_KONTANTSTØTTE -> TODO()
        Dokumenttype.KLAGE_BLANKETT_SAKSBEHANDLING_OVERGANGSSTØNAD -> TODO()
        Dokumenttype.KLAGE_BLANKETT_SAKSBEHANDLING_BARNETILSYN -> TODO()
        Dokumenttype.KLAGE_BLANKETT_SAKSBEHANDLING_SKOLEPENGER -> TODO()
        Dokumenttype.KLAGE_BLANKETT_SAKSBEHANDLING_BARNETRYGD -> TODO()
        Dokumenttype.KLAGE_BLANKETT_SAKSBEHANDLING_KONTANTSTØTTE -> TODO()
    }
}
